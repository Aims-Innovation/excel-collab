import { a as Li, p as Zn, C as Ri, j as gt, d as Ei } from "./index-DjDbBtVe.mjs";
...
function rh(i) {
  const {
    ...
    updateMode: l,
    uuid: c
  } = i, h = Ii(null), d = Ii(null);
  Fi(() => {
    d.current && (a ? (u(), setTimeout(f)) : (Ei(d.current.data, r) || (d.current.data = r), n && !Ei(d.current.options, n) && (d.current.options = n), d.current.update(l)));
  }, [a, l, r, n]), Fi(() => (f(), () => u()), []);
  const f = () => {
...
function $t(i, t) {
  return Ne.register(t), sn((e) => /* @__PURE__ */ gt.jsx(rh, { ...e, type: i }));
}
...
function Qt(i) {
  const t = Math.floor(i) % Ri.length;
  return Ri[t];
}
const ph = sn((i) => {
  ...
  let h;
  if (t === "line")
    h = /* @__PURE__ */ gt.jsx(ah, { ...c, data: l });
  else if (t === "bar")
    h = /* @__PURE__ */ gt.jsx(lh, { ...c, data: l });
  else if (t === "pie")
    h = /* @__PURE__ */ gt.jsx(ch, { ...c, data: l });
  else if (t === "radar") {
    const d = {
      labels: n,
      datasets: o.map((f, u) => {
        ...
        return {
          ...
          pointBorderColor: Li("white"),
          pointHoverBackgroundColor: Li("white"),
...
//# sourceMappingURL=Chart-D58SMJwM.mjs.map
