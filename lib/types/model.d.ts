...
import { ModelRoot, ModelJSON } from './yjs';
...
export type BorderType = 'thin' | 'hair' | 'dotted' | 'dashed' | 'dashDot' | 'dashDotDot' | 'double' | 'medium' | 'mediumDashed' | 'mediumDashDot' | 'mediumDashDotDot' | 'thick';
...
export type ModelCellValue = ModelCellType & Pick<IRange, 'sheetId' | 'row' | 'col'>;
export interface CustomItem {
    len: number;
    isHide: boolean;
}
export type CustomHeightOrWidthItem = Record<string, CustomItem>;
...
export type ChangeEventType = keyof ModelJSON | 'cellStyle' | 'antLine' | 'redo' | 'undo';
export interface EventType {
    changeSet: Set<ChangeEventType>;
}
export declare enum EMergeCellType {
    MERGE_CENTER = 0,
    MERGE_CELL = 1,
    MERGE_CONTENT = 2
}
...
export interface IBaseModel extends Pick<IWorkbook, 'setCurrentSheetId' | 'getCurrentSheetId' | 'addSheet' | 'deleteSheet' | 'hideSheet' | 'unhideSheet' | 'renameSheet' | 'getSheetInfo' | 'updateSheetInfo' | 'getSheetList' | 'deleteAll' | 'fromJSON'>, Pick<IRangeMap, 'setActiveRange' | 'getActiveRange' | 'validateRange'>, Pick<IDrawings, 'getDrawingList' | 'addDrawing' | 'updateDrawing' | 'deleteDrawing' | 'validateDrawing'>, Pick<IDefinedName, 'getDefineName' | 'setDefineName' | 'checkDefineName' | 'getDefineNameList' | 'validateDefinedName'>, Pick<IMergeCell, 'getMergeCellList' | 'addMergeCell' | 'deleteMergeCell'>, Pick<IRow, 'hideRow' | 'getRow' | 'setRowHeight' | 'unhideRow'>, Pick<ICol, 'hideCol' | 'getCol' | 'setColWidth' | 'unhideCol'>, Pick<IWorksheet, 'addRow' | 'deleteRow' | 'addCol' | 'deleteCol' | 'getCell' | 'setCell' | 'updateCellStyle' | 'getWorksheet' | 'setWorksheet' | 'setCellValue' | 'deleteCell'>, Pick<IFilter, 'addFilter' | 'getFilter' | 'deleteFilter' | 'updateFilter'> {
    toJSON(): ModelJSON;
    canRedo(): boolean;
    canUndo(): boolean;
    undo(): void;
...
export interface IEventEmitter<EventType extends Record<string, unknown> = Record<string, unknown>> {
 ...
 *
 */
export interface IModel extends IBaseModel, Pick<IScroll, 'getScroll' | 'setScroll'>, IEventEmitter<ModelEventEmitterType> {
    /**
     * Pastes a range of cells.
     *
