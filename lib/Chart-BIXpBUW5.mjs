...
import { a as Ei, p as Zn, C as Ii, d as Fi } from "./index-B1lCBgHT.mjs";
function ue(i) {
  return i + 0.5 | 0;
}
const pt = (i, t, e) => Math.max(Math.min(i, e), t);
function te(i) {
  return pt(ue(i * 2.55), 0, 255);
}
function xt(i) {
  return pt(ue(i * 255), 0, 255);
}
function ht(i) {
  return pt(ue(i / 2.55) / 100, 0, 1);
}
function zi(i) {
  return pt(ue(i * 100), 0, 100);
}
...
function po() {
  const i = {}, t = Object.keys(Vi), e = Object.keys(Bi);
  let s, n, o, r, a;
...
class ae {
  constructor(t) {
    ...
    const e = typeof t;
    let s;
    e === "object" ? s = Wi(t) : e === "string" && (s = io(t) || mo(t) || vo(t)), this._rgb = s, this._valid = !!s;
  }
  get valid() {
    return this._valid;
  }
...
const ce = (i) => typeof i < "u", yt = (i) => typeof i == "function", Ni = (i, t) => {
  if (i.size !== t.size)
    return !1;
  for (const e of i)
    if (!t.has(e))
...
const L = Math.PI, F = 2 * L, Ao = F + L, Le = Number.POSITIVE_INFINITY, Oo = L / 180, H = L / 2, St = L / 4, ji = L * 2 / 3, cn = Math.log10, rt = Math.sign;
function ne(i, t, e) {
...
const ki = (i) => i === "start" ? "left" : i === "end" ? "right" : "center", X = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2, Ho = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
function pn(i, t, e) {
  const s = t.length;
  let n = 0, o = s;
  if (i._sorted) {
    ...
    if (g) {
      let p = Math.max(
        // @ts-expect-error Need to type _parsed
        At(l, r.axis, f, !0).hi + 1,
        // @ts-expect-error Need to fix types on _lookupByKey
        e ? 0 : At(t, h, r.getPixelForValue(f), !0).hi + 1
      );
      if (c) {
...
const xe = (i) => i === 0 || i === 1, Ui = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * F / e)), Ki = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * F / e) + 1, oe = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
  ...
  for (l = 0; l < a; l++)
    if (d = e[l], d != null && !B(d))
      ...
      for (c = 0, h = d.length; c < h; c++)
        f = d[c], f != null && !B(f) && (r = Re(i, n, o, r, f));
  i.restore();
  const u = o.length / 2;
  if (u > e.length) {
    for (l = 0; l < u; l++)
  ...
  if (!(isNaN(p) || p <= 0)) {
    switch (i.beginPath(), u) {
      ...
      case "triangle":
        ...
        break;
      case "rectRounded":
        c = p * 0.516, l = p - c, r = Math.cos(m + St) * l, d = Math.cos(m + St) * (n ? n / 2 - c : l), a = Math.sin(m + St) * l, f = Math.sin(m + St) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - L, m - H), i.arc(e + f, s - r, c, m - H, m), i.arc(e + d, s + a, c, m, m + H), i.arc(e - f, s + r, c, m + H, m + L), i.closePath();
        break;
      case "rect":
        if (!g) {
      ...
      case "cross":
        ...
        break;
      case "star":
        d = Math.cos(m) * (n ? n / 2 : p), r = Math.cos(m) * p, a = Math.sin(m) * p, f = Math.sin(m) * (n ? n / 2 : p), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + f, s - r), i.lineTo(e - f, s + r), m += St, d = Math.cos(m) * (n ? n / 2 : p), r = Math.cos(m) * p, a = Math.sin(m) * p, f = Math.sin(m) * (n ? n / 2 : p), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + f, s - r), i.lineTo(e - f, s + r);
        break;
      case "line":
...
function hr(i, t, e) {
  ...
  let a = s[t];
  return yt(a) && r.isScriptable(t) && (a = dr(t, a, i, e)), B(a) && a.length && (a = fr(t, a, i, r.isIndexable)), Ci(t, a) && (a = Ht(a, n, o && o[t], r)), a;
}
function dr(i, t, e, s) {
...
const ur = (i, t) => i === !0 ? t : typeof i == "string" ? _t(t, i) : void 0;
...
const xr = Number.EPSILON || 1e-14, Nt = (i, t) => t < i.length && !i[t].skip && i[t], Sn = (i) => i === "x" ? "y" : "x";
function _r(i, t, e, s) {
...
function Mr(i, t) {
  ...
  for (e = 0, s = i.length; e < s; ++e)
    r = o, o = a, a = e < s - 1 && ft(i[e + 1], t), o && (n = i[e], r && (n.cp1x = ye(n.cp1x, t.left, t.right), n.cp1y = ye(n.cp1y, t.top, t.bottom)), a && (n.cp2x = ye(n.cp2x, t.left, t.right), n.cp2y = ye(n.cp2y, t.top, t.bottom)));
}
...
function Ct(i, t) {
  if ("native" in i)
    return i;
  const { canvas: e, currentDevicePixelRatio: s } = t, n = We(e), o = n.boxSizing === "border-box", r = Tt(n, "padding"), a = Tt(n, "border", "width"), { x: l, y: c, box: h } = Dr(i, e), d = r.left + (h && a.left), f = r.top + (h && a.top);
...
function Ar(i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o)
      ...
      const r = o.getBoundingClientRect(), a = We(o), l = Tt(a, "border", "width"), c = Tt(a, "padding");
...
function Or(i, t, e, s) {
  const n = We(i), o = Tt(n, "margin"), r = Ee(n.maxWidth, i, "clientWidth") || Le, a = Ee(n.maxHeight, i, "clientHeight") || Le, l = Ar(i, t, e);
...
function Dn(i, t, e) {
  ...
  const { property: s, start: n, end: o } = e, r = t.length, { compare: a, between: l, normalize: c } = Cn(s), { start: h, end: d, loop: f, style: u } = Fr(i, t, e), g = [];
...
function ss(i, t, e, s) {
  return !s || !s.setContext || !e ? t : Wr(i, t, e, s);
}
function Wr(i, t, e, s) {
  ...
  for (const g of t) {
    ...
    for (f = d + 1; f <= g.end; f++) {
      ...
      m = ns(s.setContext(vt(n, {
        ...
        p1DataIndex: f % l,
        datasetIndex: r
      }))), Hr(m, h) && u(d, f - 1, g.loop, h), p = b, h = m;
    }
...
function cs(i, t) {
  ...
  for (let u = 0; u < d; ++u) {
    ...
    f = b[c] = Qr(n, h, p), f[a] = m, f._top = ls(f, r, !0, s.type), f._bottom = ls(f, r, !1, s.type);
...
class Et {
  ...
  linkScales() {
    const t = this.chart, e = this._cachedMeta, s = this.getDataset(), n = (d, f, u, g) => d === "x" ? f : d === "r" ? g : u, o = e.xAxisID = P(s.xAxisID, Ge(t, "x")), r = e.yAxisID = P(s.yAxisID, Ge(t, "y")), a = e.rAxisID = P(s.rAxisID, Ge(t, "r")), l = e.indexAxis, c = e.iAxisID = n(l, o, r, a), h = e.vAxisID = n(l, r, o, a);
  ...
  _dataCheck() {
    ...
    if (A(e)) {
      ...
      e && Object.isExtensible(e) && Vo(e, this), this._syncList = [], this._data = e;
    }
  }
  addElements() {
    const t = this._cachedMeta;
  ...
  _resolveElementOptions(t, e = "default", s) {
    ...
    const c = this.chart.config, h = c.datasetElementScopeKeys(this._type, t), d = n ? [
      ...
      t,
      ""
    ], f = c.getOptionScopes(this.getDataset(), h), u = Object.keys(V.elements[t]), g = () => this.getContext(s, n, e), p = c.resolveNamedOptions(f, u, g, d);
...
function sa(i, t) {
  if (!i._cache.$bar) {
    ...
    i._cache.$bar = fn(s.sort((n, o) => n - o));
  }
  return i._cache.$bar;
}
function na(i) {
...
function ds(i, t, e, s) {
  ...
  let c, h, d, f;
  for (c = e, h = e + s; c < h; ++c)
    f = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(Rn(f, d, o, c));
  return l;
}
function Ze(i) {
...
function ha(i, t, e, s) {
  ...
  n === "middle" && e && (i.enableBorderRadius = !0, (e._top || 0) === s ? n = c : (e._bottom || 0) === s ? n = h : (o[fs(h, r, a, l)] = !0, n = c)), o[fs(n, r, a, l)] = !0, i.borderSkipped = o;
}
function fs(i, t, e, s) {
  return s ? (i = da(i, t, e), i = us(i, e, t)) : i = us(i, t, e), i;
}
function da(i, t, e) {
...
function fa(i, { inflateAmount: t }, e) {
...
class ua extends Et {
  ...
  parseObjectData(t, e, s, n) {
    ...
    let f, u, g, p;
    for (f = s, u = s + n; f < u; ++f)
      p = e[f], g = {}, g[o.axis] = o.parse(_t(p, c), f), d.push(Rn(_t(p, h), g, r, f));
    return d;
  }
  updateRangeFromParsed(t, e, s, n) {
  ...
  updateElements(t, e, s, n) {
    ...
    for (let u = e; u < e + s; u++) {
      const g = this.getParsed(u), p = o || T(g[a.axis]) ? {
        base: l,
        head: l
      ...
      ha(x, y, b, r), fa(x, y, h.ratio), this.updateElement(t[u], u, x, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    u !== d && (f = u - d, u = d), h && (d = c.barStart, u = c.barEnd - c.barStart, d !== 0 && rt(d) !== rt(c.barEnd) && (f = 0), f += d);
    const m = !T(o) && !h ? o : f;
...
function ga(i, t, e) {
  let s = 1, n = 1, o = 0, r = 0;
  if (t < F) {
    const a = i, l = a + t, c = Math.cos(a), h = Math.sin(a), d = Math.cos(l), f = Math.sin(l), u = (y, v, _) => he(y, a, l, !0) ? 1 : Math.max(v, v * e, _, _ * e), g = (y, v, _) => he(y, a, l, !0) ? -1 : Math.min(v, v * e, _, _ * e), p = u(0, c, d), m = u(H, h, f), b = g(L, c, d), x = g(L + H, h, f);
...
class ma extends Et {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset", { iScale: r, vScale: a, _stacked: l, _dataset: c } = this._cachedMeta, { sharedOptions: h, includeOptions: d } = this._getSharedOptions(e, n), f = r.axis, u = a.axis, { spanGaps: g, segment: p } = this.options, m = Wt(g) ? g : Number.POSITIVE_INFINITY, b = this.chart._animationsDisabled || o || n === "none", x = e + s, y = t.length;
    ...
    for (let _ = 0; _ < y; ++_) {
      ...
      const S = this.getParsed(_), w = T(S[u]), C = M[f] = r.getPixelForValue(S[f], _), D = M[u] = o || w ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[u], _);
      M.skip = isNaN(C) || isNaN(D) || w, M.stop = _ > 0 && Math.abs(S[f] - v[f]) > m, p && (M.parsed = S, M.raw = c.data[_]), d && (M.options = h || this.resolveDataElementOptions(_, k.active ? "active" : n)), b || this.updateElement(k, _, M, n), v = S;
    }
  }
  getMaxOverflow() {
...
class ba extends Et {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset", r = this.chart, l = r.options.animation, c = this._cachedMeta.rScale, h = c.xCenter, d = c.yCenter, f = c.getIndexAngle(0) - 0.5 * L;
    let u = f, g;
...
class ya extends Et {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset", { iScale: r, vScale: a, _stacked: l, _dataset: c } = this._cachedMeta, h = this.resolveDataElementOptions(e, n), d = this.getSharedOptions(h), f = this.includeOptions(n, d), u = r.axis, g = a.axis, { spanGaps: p, segment: m } = this.options, b = Wt(p) ? p : Number.POSITIVE_INFINITY, x = this.chart._animationsDisabled || o || n === "none";
    let y = e > 0 && this.getParsed(e - 1);
    for (let v = e; v < e + s; ++v) {
      const _ = t[v], k = this.getParsed(v), M = x ? _ : {}, S = T(k[g]), w = M[u] = r.getPixelForValue(k[u], v), C = M[g] = o || S ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, k, l) : k[g], v);
      M.skip = isNaN(w) || isNaN(C) || S, M.stop = v > 0 && Math.abs(k[u] - y[u]) > b, m && (M.parsed = k, M.raw = c.data[v]), f && (M.options = d || this.resolveDataElementOptions(v, _.active ? "active" : n)), x || this.updateElement(_, v, M, n), y = k;
    }
...
function ka(i, t, e, s) {
  ...
  if (a && t === a.axis && t !== "r" && r && o.length) {
    ...
    if (s) {
      ...
      const h = c(o, t, e);
      if (l) {
        const { vScale: d } = n._cachedMeta, { _parsed: f } = i, u = f.slice(0, h.lo + 1).reverse().findIndex((p) => !T(p[d.axis]));
        h.lo -= Math.max(0, u);
        const g = f.slice(h.hi).findIndex((p) => !T(p[d.axis]));
        h.hi += Math.max(0, g);
      }
      return h;
    }
...
function He(i, t, e, s, n) {
  ...
  for (let a = 0, l = o.length; a < l; ++a) {
    const { index: c, data: h } = o[a], { lo: d, hi: f } = ka(o[a], t, r, n);
    for (let u = d; u <= f; ++u) {
      const g = h[u];
      g.skip || s(g, c, u);
    }
...
function Ta(i, t, e, s) {
  ...
  o.getPadding && In(r, o.getPadding());
...
function ee(i, t, e, s) {
  ...
  for (o = 0, r = i.length, c = 0; o < r; ++o) {
    ...
    const { same: d, other: f } = Ta(t, e, a, s);
...
function bs(i, t, e, s) {
  ...
  for (const a of i) {
    ...
    if (a.horizontal) {
      ...
      ce(c.start) && (r = c.start), l.fullSize ? ke(l, n.left, r, e.outerWidth - n.right - n.left, f) : ke(l, t.left + c.placed, r, d, f), c.start = r, c.placed += d, r = l.bottom;
    } else {
      const d = t.h * h, f = c.size || l.width;
      ce(c.start) && (o = c.start), l.fullSize ? ke(l, o, n.top, f, e.outerHeight - n.bottom - n.top) : ke(l, o, t.top + c.placed, f, d), c.start = o, c.placed += d, o = l.right;
    }
  }
  t.x = o, t.y = r;
}
var tt = {
  ...
  update(i, t, e, s) {
    ...
    ee(a.fullSize, u, d, g), ee(l, u, d, g), ee(c, u, d, g) && ee(l, u, d, g), La(u), bs(a.leftAndTop, u, d, g), u.x += u.w, u.y += u.h, bs(a.rightAndBottom, u, d, g), i.chartArea = {
      left: u.left,
      top: u.top,
      right: u.left + u.w,
      bottom: u.top + u.h,
...
function Va(i, t) {
  const e = Ia[i.type] || i.type, { x: s, y: n } = Ct(i, t);
  return {
    type: e,
    chart: t,
    native: i,
...
function Bn() {
  ...
  i !== _s && (_s = i, fe.forEach((t, e) => {
    e.currentDevicePixelRatio !== i && t();
  }));
}
function Na(i, t) {
  fe.size || window.addEventListener("resize", Bn), fe.set(i, t);
}
function ja(i) {
  fe.delete(i), fe.size || window.removeEventListener("resize", Bn);
}
function $a(i, t, e) {
...
function Ka(i, t) {
  ...
  if (r > 0) {
    ...
    for (Me(t, c, h, T(u) ? 0 : a - u, a), d = 0, f = r - 1; d < f; d++)
      Me(t, c, h, o[d], o[d + 1]);
    return Me(t, c, h, l, T(u) ? t.length : l + u), c;
  }
  return Me(t, c, h), c;
}
function qa(i) {
...
function Ms(i, t) {
  if (!i.display)
    return 0;
  const e = N(i.font, t), s = q(i.padding);
...
function rl(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    ...
    } else e === "center" ? u = (c.left + c.right) / 2 - m + t : u = ys(i, e, t);
...
class jt extends ut {
  ...
  calculateLabelRotation() {
    ...
    a = t.offset ? this.maxWidth / s : u / (s - 1), d + 6 > a && (a = u / (s - (t.offset ? 0.5 : 1)), l = this.maxHeight - Gt(t.grid) - e.padding - Ms(t.title, this.chart.options.font), c = Math.sqrt(d * d + f * f), r = yi(Math.min(Math.asin(K((h.highest.height + 6) / a, -1, 1)), Math.asin(K(l / c, -1, 1)) - Math.asin(K(f / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
  }
    ...
    for (d = 0; d < e; d += l) {
      if (g = t[d].label, p = this._resolveTickFontOptions(d), n.font = m = p.string, b = o[m] = o[m] || {
        ...
        for (f = 0, u = g.length; f < u; ++f)
          _ = g[f], !T(_) && !B(_) && (y = Re(n, b.data, b.gc, y, _), v += x);
  ...
  getPixelForDecimal(t) {
    ...
    return Fo(this._alignToPixels ? wt(this.chart, e, 0) : e);
  }
  ...
  _computeGridLineItems(t) {
    const e = this.axis, s = this.chart, n = this.options, { grid: o, position: r, border: a } = n, l = o.offset, c = this.isHorizontal(), d = this.ticks.length + (l ? 1 : 0), f = Gt(o), u = [], g = a.setContext(this.getContext()), p = g.display ? g.width : 0, m = p / 2, b = function(z) {
      return wt(s, z, p);
    };
    let x, y, v, _, k, M, S, w, C, D, O, $;
    if (r === "top")
      x = b(this.bottom), M = this.bottom - f, w = x - m, D = b(t.top) + m, $ = t.bottom;
    else if (r === "bottom")
      x = b(this.top), D = t.top, $ = b(t.bottom) - m, M = x + m, w = this.top + f;
    else if (r === "left")
      x = b(this.right), k = this.right - f, S = x - m, C = b(t.left) + m, O = t.right;
    else if (r === "right")
      x = b(this.left), C = t.left, O = b(t.right) - m, k = x + m, S = this.left + f;
    else if (e === "x") {
      if (r === "center")
      ...
      k = x - m, S = k - f, C = t.left, O = t.right;
    }
    const Z = P(n.ticks.maxTicksLimit, d), E = Math.max(1, Math.ceil(d / Z));
    for (y = 0; y < d; y += E) {
      const z = this.getContext(y), W = o.setContext(z), et = a.setContext(z), Y = W.lineWidth, It = W.color, ge = et.dash || [], Ft = et.dashOffset, Yt = W.tickWidth, kt = W.tickColor, Xt = W.tickBorderDash || [], Mt = W.tickBorderDashOffset;
      v = el(this, y, l), v !== void 0 && (_ = wt(s, v, Y), c ? k = S = C = O = _ : M = w = D = $ = _, u.push({
        tx1: k,
        ty1: M,
        tx2: S,
        ty2: w,
  ...
  _computeLabelItems(t) {
    const e = this.axis, s = this.options, { position: n, ticks: o } = s, r = this.isHorizontal(), a = this.ticks, { align: l, crossAlign: c, padding: h, mirror: d } = o, f = Gt(s.grid), u = f + h, g = d ? -h : u, p = -it(this.labelRotation), m = [];
    ...
    if (n === "top")
      ...
      if (n === "center")
        ...
        k = this.chart.scales[E].getPixelForValue(z) + u;
      }
    ...
    for (b = 0, x = a.length; b < x; ++b) {
      ...
      const z = D / 2, W = E.color, et = E.textStrokeColor, Y = E.textStrokeWidth;
      let It = M;
      r ? (_ = S, M === "inner" && (b === x - 1 ? It = this.options.reverse ? "left" : "right" : b === 0 ? It = this.options.reverse ? "right" : "left" : It = "center"), n === "top" ? c === "near" || p !== 0 ? O = -D * C + C / 2 : c === "center" ? O = -Z.highest.height / 2 - z * C + C : O = -Z.highest.height + C / 2 : c === "near" || p !== 0 ? O = C / 2 : c === "center" ? O = Z.highest.height / 2 - z * C : O = Z.highest.height - D * C, d && (O *= -1), p !== 0 && !E.showLabelBackdrop && (_ += C / 2 * Math.sin(p))) : (k = S, O = (1 - D) * C / 2);
      let ge;
      if (E.showLabelBackdrop) {
        const Ft = q(E.backdropPadding), Yt = Z.heights[b], kt = Z.widths[b];
        let Xt = O - Ft.top, Mt = 0 - Ft.left;
        switch ($) {
          case "middle":
            Xt -= Yt / 2;
            break;
  ...
  drawTitle() {
    ...
    if (!s.display)
      return;
    const o = N(s.font), r = q(s.padding), a = s.align;
    let l = o.lineHeight / 2;
    e === "bottom" || e === "center" || A(e) ? (l += r.bottom, B(s.text) && (l += o.lineHeight * (s.text.length - 1))) : l += r.top;
    const { titleX: c, titleY: h, maxWidth: d, rotation: f } = rl(this, l, e, a);
    Rt(t, s.text, 0, 0, o, {
      color: s.color,
      maxWidth: d,
      rotation: f,
...
class Se {
  ...
  register(t) {
    ...
    return o in n || (n[o] = t, al(t, r, s), this.override && V.override(t.id, t.overrides)), r;
  }
  get(t) {
    return this.items[t];
  }
  unregister(t) {
    ...
    s in e && delete e[s], n && s in V[n] && (delete V[n][s], this.override && delete Lt[s]);
  }
}
function al(i, t, e) {
  ...
  V.set(t, s), i.defaultRoutes && ll(t, i.defaultRoutes), i.descriptors && V.describe(t, i.descriptors);
}
function ll(i, t) {
...
class hl {
  constructor() {
    this.controllers = new Se(Et, "datasets", !0), this.elements = new Se(ut, "elements"), this.plugins = new Se(Object, "plugins"), this.scales = new Se(jt, "scales"), this._typedRegistries = [
      this.controllers,
      this.scales,
      this.elements
    ];
...
class dl {
  ...
  _createDescriptors(t, e) {
    const s = t && t.config, n = P(s.options && s.options.plugins, {}), o = fl(s);
...
function yl(i, t) {
  ...
  return Object.keys(s).forEach((r) => {
    ...
    const l = di(r, a, _l(r, i), V.scales[a.type]), c = bl(l, n), h = e.scales || {};
...
const Ps = /* @__PURE__ */ new Map(), Hn = /* @__PURE__ */ new Set();
function we(i, t) {
  let e = Ps.get(i);
  return e || (e = t(), Ps.set(i, e), Hn.add(e)), e;
}
const Jt = (i, t, e) => {
  const s = _t(t, e);
  s !== void 0 && i.add(s);
...
class kl {
  ...
  getOptionScopes(t, e, s) {
    ...
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => Jt(l, t, d))), h.forEach((d) => Jt(l, n, d)), h.forEach((d) => Jt(l, Lt[o] || {}, d)), h.forEach((d) => Jt(l, V, d)), h.forEach((d) => Jt(l, li, d));
    });
    const c = Array.from(l);
    return c.length === 0 && c.push(/* @__PURE__ */ Object.create(null)), Hn.has(e) && r.set(e, c), c;
  }
  chartOptionScopes() {
...
let Ne = class {
  ...
  constructor(t, e) {
    const s = this.config = new kl(e), n = Nn(t), o = Ts(n);
    if (o)
    ...
    if (this.id = ko(), this.ctx = a, this.canvas = l, this.width = h, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new dl(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = Wo((d) => this.update(d), r.resizeDelay || 0), this._dataChanges = [], Ae[this.id] = this, !a || !l) {
  ...
  _drawDataset(t) {
    ...
    this.notifyPlugins("beforeDatasetDraw", s) !== !1 && (n && Be(e, n), t.controller.draw(), n && Ve(e), s.cancelable = !1, this.notifyPlugins("afterDatasetDraw", s));
  }
  isPointInArea(t) {
...
function Ls() {
  return R(Ne.instances, (i) => i._plugins.invalidate());
}
function Ol(i, t, e) {
  ...
  if (i.beginPath(), i.arc(n, o, r - c / 2, s + d / 2, e - d / 2), a > 0) {
    const f = Math.min(c / a, U(s - e));
    i.arc(n, o, a + c / 2, e - f / 2, s + f / 2, !0);
  } else {
    const f = Math.min(c / 2, r * U(s - e));
    if (h === "round")
      i.arc(n, o, f, e - L / 2, s + L / 2, !0);
    else if (h === "bevel") {
      const u = 2 * f * f, g = -u * Math.cos(e + L / 2) + n, p = -u * Math.sin(e + L / 2) + o, m = u * Math.cos(s + L / 2) + n, b = u * Math.sin(s + L / 2) + o;
...
function Fe(i, t, e, s, n, o) {
  ...
  const g = n - l;
  if (s) {
    const E = h > 0 ? h - s : 0, z = d > 0 ? d - s : 0, W = (E + z) / 2, et = W !== 0 ? g * W / (W + s) : g;
    u = (g - et) / 2;
  }
  const p = Math.max(1e-3, g * d - e / L) / d, m = (g - p) / 2, b = l + m + u, x = n - m - u, { outerStart: y, outerEnd: v, innerStart: _, innerEnd: k } = Rl(t, f, d, x - b), M = d - y, S = d - v, w = b + y / M, C = x - v / S, D = f + _, O = f + k, $ = b + _ / D, Z = x - k / O;
  if (i.beginPath(), o) {
    const E = (w + C) / 2;
    if (i.arc(r, a, d, w, E), i.arc(r, a, d, E, C), v > 0) {
      const Y = Bt(S, C, r, a);
      i.arc(Y.x, Y.y, v, C, x + H);
    }
    const z = Bt(O, x, r, a);
    if (i.lineTo(z.x, z.y), k > 0) {
      const Y = Bt(O, Z, r, a);
      i.arc(Y.x, Y.y, k, x + H, Z + Math.PI);
    }
    const W = (x - k / f + (b + _ / f)) / 2;
    if (i.arc(r, a, f, x - k / f, W, !0), i.arc(r, a, f, W, b + _ / f, !0), _ > 0) {
      const Y = Bt(D, $, r, a);
      i.arc(Y.x, Y.y, _, $ + Math.PI, b - H);
    }
    const et = Bt(M, b, r, a);
    if (i.lineTo(et.x, et.y), y > 0) {
      const Y = Bt(M, w, r, a);
      i.arc(Y.x, Y.y, y, b - H, w);
    }
  } else {
    i.moveTo(r, a);
    const E = Math.cos(w) * d + r, z = Math.sin(w) * d + a;
    i.lineTo(E, z);
    const W = Math.cos(C) * d + r, et = Math.sin(C) * d + a;
    i.lineTo(W, et);
  }
  i.closePath();
}
function El(i, t, e, s, n) {
  ...
  return Fe(i, t, e, s, l, n), i.fill(), l;
}
function Il(i, t, e, s, n) {
  ...
  g && Tl(i, t, p), l.selfJoin && p - r >= L && u === 0 && h !== "miter" && Ol(i, t, p), o || (Fe(i, t, e, s, p, n), i.stroke());
}
class Fl extends ut {
  static id = "arc";
  static defaults = {
  ...
  inRange(t, e, s) {
    const n = this.getProps([
      ...
      "outerRadius",
      "circumference"
    ], s), f = (this.options.spacing + this.options.borderWidth) / 2, u = P(d, l - a), g = he(o, a, l) && a !== l, p = u >= F || g, m = dt(r, c + f, h + f);
    return p && m;
  }
  getCenterPoint(t) {
  ...
  draw(t) {
    ...
    t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor, El(t, this, c, o, r), Il(t, this, c, o, r), t.restore();
  }
}
function jn(i, t, e = t) {
...
function jl(i, t, e, s) {
  const { segments: n, options: o } = t, r = fi(t);
  for (const a of n)
...
function Yl(i, t, e, s) {
  $l && !t.options.segment ? Nl(i, t, e, s) : jl(i, t, e, s);
}
class je extends ut {
  static id = "line";
  static defaults = {
  ...
  pathSegment(t, e, s) {
    return fi(this)(t, this, e, s);
  }
  path(t, e, s) {
    const n = this.segments, o = fi(this);
    let r = this._loop;
...
class Xl extends ut {
  ...
  */
  ...
  draw(t, e) {
    const s = this.options;
    this.skip || s.radius < 0.1 || !ft(this, e, this.size(s) / 2) || (t.strokeStyle = s.borderColor, t.lineWidth = s.borderWidth, t.fillStyle = s.backgroundColor, ci(t, s, this.x, this.y));
  }
  getRange() {
...
function Ql(i, t, e) {
  ...
  for (const a of s) {
    ...
    const d = An(t, h);
    for (const f of d) {
      const u = ui(e, o[f.start], o[f.end], f.loop), g = Dn(a, n, u);
      for (const p of g)
        r.push({
          source: p,
          target: f,
          start: {
            [e]: Es(h, u, "start", Math.max)
          },
          end: {
            [e]: Es(h, u, "end", Math.min)
          }
        });
    }
  }
...
function ni(i, t, e) {
  const s = dc(t), { chart: n, index: o, line: r, scale: a, axis: l } = t, c = r.options, h = c.fill, d = c.backgroundColor, { above: f = d, below: u = d } = h || {}, g = n.getDatasetMeta(o), p = On(n, g);
...
function mc(i, t) {
  ...
  o !== n && (c === "x" ? (Fs(i, s, r.top), oi(i, {
    ...
    property: c,
    clip: l
  }), i.restore(), i.save(), Fs(i, s, r.bottom)) : c === "y" && (zs(i, s, r.left), oi(i, {
    line: e,
    target: s,
    color: o,
    scale: a,
...
function oi(i, t) {
  ...
  for (const { source: c, target: h, start: d, end: f } of l) {
    ...
    i.save(), i.fillStyle = u, bc(i, r, a, g && ui(n, d, f)), i.beginPath();
    const p = !!e.pathSegment(i, c);
    let m;
    if (g) {
      p ? i.closePath() : Bs(i, s, f, n);
...
var xc = {
  ...
  beforeDatasetsDraw(i, t, e) {
    ...
    for (let n = s.length - 1; n >= 0; --n) {
      const o = s[n].$filler;
      Is(o) && ni(i.ctx, o, i.chartArea);
    }
  },
  beforeDatasetDraw(i, t, e) {
    const s = t.meta.$filler;
    !Is(s) || e.drawTime !== "beforeDatasetDraw" || ni(i.ctx, s, i.chartArea);
  },
  defaults: {
    propagate: !0,
...
class Ws extends ut {
  ...
  fit() {
    ...
    const s = t.labels, n = N(s.font), o = n.size, r = this._computeTitleHeight(), { boxWidth: a, itemHeight: l } = Vs(s, o);
    let c, h;
  ...
  adjustHitBoxes() {
    if (!this.options.display)
      return;
    const t = this._computeTitleHeight(), { legendHitBoxes: e, options: { align: s, labels: { padding: n }, rtl: o } } = this, r = Vt(o, this.left, this.width);
    if (this.isHorizontal()) {
  ...
  draw() {
    if (this.options.display) {
      const t = this.ctx;
      Be(t, this), this._draw(), Ve(t);
    }
  }
  _draw() {
    const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this, { align: o, labels: r } = t, a = V.color, l = Vt(t.rtl, this.left, this.width), c = N(r.font), { padding: h } = r, d = c.size, f = d / 2;
    let u;
    this.drawTitle(), n.textAlign = l.textAlign("left"), n.textBaseline = "middle", n.lineWidth = 0.5, n.font = c.string;
    const { boxWidth: g, boxHeight: p, itemHeight: m } = Vs(r, d), b = function(k, M, S) {
    ...
    this.legendItems.forEach((k, M) => {
      ...
      const S = n.measureText(k.text).width, w = l.textAlign(k.textAlign || (k.textAlign = r.textAlign)), C = g + f + S;
      let D = u.x, O = u.y;
      l.setWidth(this.width), y ? M > 0 && D + C + h > this.right && (O = u.y += _, u.line++, D = u.x = X(o, this.left + h, this.right - s[u.line])) : M > 0 && O + _ > this.bottom && (D = u.x = D + e[u.line].width + h, u.line++, O = u.y = X(o, this.top + v + h, this.bottom - e[u.line].height));
      const $ = l.x(D);
      if (b($, O, k), D = Ho(w, D + g + f, y ? D + C : this.right, t.rtl), x(l.x(D), O, k), y)
        u.x += C + h;
  ...
  drawTitle() {
    const t = this.options, e = t.title, s = N(e.font), n = q(e.padding);
    if (!e.display)
      return;
    const o = Vt(t.rtl, this.left, this.width), r = this.ctx, a = e.position, l = s.size / 2, c = n.top + l;
    ...
    const u = X(a, d, d + f);
    r.textAlign = o.textAlign(ki(a)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = s.string, Rt(r, e.text, u, h, s);
  }
  _computeTitleHeight() {
    const t = this.options.title, e = N(t.font), s = q(t.padding);
...
class qn extends ut {
  ...
  draw() {
    ...
    if (!e.display)
      return;
    const s = N(e.font), o = s.lineHeight / 2 + this._padding.top, { titleX: r, titleY: a, maxWidth: l, rotation: c } = this._drawArgs(o);
    Rt(t, e.text, 0, 0, s, {
      color: e.color,
      maxWidth: l,
      rotation: c,
...
function Hs(i, t) {
  const e = i.chart.ctx, { body: s, footer: n, title: o } = i, { boxWidth: r, boxHeight: a } = t, l = N(t.bodyFont), c = N(t.titleFont), h = N(t.footerFont), d = o.length, f = n.length, u = s.length, g = q(t.padding);
...
class Xs extends ut {
  ...
  _createItems(t) {
    ...
    return t.filter && (a = a.filter((h, d, f) => t.filter(h, d, f, s))), t.itemSort && (a = a.sort((h, d) => t.itemSort(h, d, s))), R(a, (h) => {
  ...
  update(t, e) {
    ...
    if (!n.length)
      ...
      const l = this._size = Hs(this, s), c = Object.assign({}, a, l), h = Ns(this.chart, s, c), d = js(s, c, h, this.chart);
  ...
  drawTitle(t, e, s) {
    ...
    if (o) {
      ...
      for (t.x = Pe(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", r = N(s.titleFont), a = s.titleSpacing, e.fillStyle = s.titleColor, e.font = r.string, l = 0; l < o; ++l)
        e.fillText(n[l], c.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + a, l + 1 === o && (t.y += s.titleMarginBottom - a);
    }
  }
  _drawColorBox(t, e, s, n, o) {
    const r = this.labelColors[s], a = this.labelPointStyles[s], { boxHeight: l, boxWidth: c } = o, h = N(o.bodyFont), d = Pe(this, "left", o), f = n.x(d), u = l < h.lineHeight ? (h.lineHeight - l) / 2 : 0, g = e.y + u;
    if (o.usePointStyle) {
      const p = {
      ...
      const p = n.leftForLtr(f, c), m = n.leftForLtr(n.xPlus(f, 1), c - 2), b = Ot(r.borderRadius);
  ...
  drawBody(t, e, s) {
    const { body: n } = this, { bodySpacing: o, bodyAlign: r, displayColors: a, boxHeight: l, boxWidth: c, boxPadding: h } = s, d = N(s.bodyFont);
    let f = d.lineHeight, u = 0;
    const g = Vt(s.rtl, this.x, this.width), p = function(S) {
      e.fillText(S, g.x(t.x + u), t.y + f / 2), t.y += f + o;
    }, m = g.textAlign(r);
    let b, x, y, v, _, k, M;
    for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = Pe(this, m, s), e.fillStyle = s.bodyColor, R(this.beforeBody, p), u = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, v = 0, k = n.length; v < k; ++v) {
      for (b = n[v], x = this.labelTextColors[v], e.fillStyle = x, R(b.before, p), y = b.lines, a && y.length && (this._drawColorBox(e, t, v, g, s), f = Math.max(d.lineHeight, l)), _ = 0, M = y.length; _ < M; ++_)
        p(y[_]), f = d.lineHeight;
      R(b.after, p);
    }
    u = 0, f = d.lineHeight, R(this.afterBody, p), t.y -= o;
  }
  drawFooter(t, e, s) {
    ...
    if (o) {
      ...
      for (t.x = Pe(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", r = N(s.footerFont), e.fillStyle = s.footerColor, e.font = r.string, a = 0; a < o; ++a)
  ...
  _updateAnimationTarget(t) {
    ...
    if (n || o) {
      ...
      if (!r)
        return;
      const a = this._size = Hs(this, t), l = Object.assign({}, r, this._size), c = Ns(e, t, l), h = js(t, l, c, e);
...
const Ic = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1, s.unshift({
  index: e,
  label: t
})) : isNaN(t) && (e = null), e);
function Fc(i, t, e, s) {
...
class Bc extends jt {
  ...
  parse(t, e) {
    if (T(t))
      return null;
    const s = this.getLabels();
    return e = isFinite(e) && s[e] === t ? e : Fc(s, t, P(e, t), this._addedLabels), zc(e, s.length - 1);
  }
  determineDataLimits() {
...
function Vc(i, t) {
  const e = [], { bounds: n, step: o, min: r, max: a, precision: l, count: c, maxTicks: h, maxDigits: d, includeBounds: f } = i, u = o || 1, g = h - 1, { min: p, max: m } = t, b = !T(r), x = !T(a), y = !T(c), v = (m - p) / (d + 1);
  let _ = $i((m - p) / g / u) * u, k, M, S, w;
  if (_ < 1e-14 && !b && !x)
    return [
      {
        value: p
  ...
  w = Math.ceil(m / _) - Math.floor(p / _), w > g && (_ = $i(w * _ / g / u) * u), T(l) || (k = Math.pow(10, l), _ = Math.ceil(_ * k) / k), n === "ticks" ? (M = Math.floor(p / _) * _, S = Math.ceil(m / _) * _) : (M = p, S = m), b && x && o && Ro((a - r) / o, _ / 1e3) ? (w = Math.round(Math.min((a - r) / _, h)), _ = (a - r) / w, M = r, S = a) : y ? (M = b ? r : M, S = x ? a : S, w = c - 1, _ = (S - M) / w) : (w = (S - M) / _, ne(w, Math.round(w), _ / 1e3) ? w = Math.round(w) : w = Math.ceil(w));
  ...
  return x && f && S !== a ? e.length && ne(e[e.length - 1].value, a, Ks(a, v, i)) ? e[e.length - 1].value = a : e.push({
    value: a
  }) : (!x || S === a) && e.push({
    value: S
  }), e;
...
function pi(i) {
  ...
  if (t.display && i.display) {
    ...
    return P(t.font && t.font.size, V.font.size) + e.height;
  }
  return 0;
}
function Hc(i, t, e) {
...
function Nc(i) {
  ...
  for (let l = 0; l < o; l++) {
    ...
    n[l] = c.padding;
    const h = i.getPointPosition(l, i.drawingArea + n[l], a), d = N(c.font), f = Hc(i.ctx, d, i._pointLabels[l]);
    s[l] = f;
    const u = U(i.getIndexAngle(l) + a), g = Math.round(yi(u)), p = qs(g, h.x, f.w, 0, 180), m = qs(g, h.y, f.h, 90, 270);
    jc(e, t, u, p, m);
  }
...
function $c(i, t, e) {
  const s = i.drawingArea, { extra: n, additionalAngle: o, padding: r, size: a } = e, l = i.getPointPosition(t, s + n + r, o), c = Math.round(yi(U(l.angle + H))), h = qc(l.y, a.h, c), d = Uc(c), f = Kc(l.x, a.w, d);
  return {
    visible: !0,
    x: l.x,
    y: h,
...
function Jc(i, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    ...
    Gc(e, r, o);
    const a = N(r.font), { x: l, y: c, textAlign: h } = o;
...
class th extends gi {
  ...
  fit() {
    const t = this.options;
    t.display && t.pointLabels.display ? Nc(this) : this.setCenterPoint(0, 0, 0, 0);
  }
  ...
  drawLabels() {
    ...
    t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(n), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach((a, l) => {
      if (l === 0 && this.min >= 0 && !e.reverse)
        return;
      const c = s.setContext(this.getContext(l)), h = N(c.font);
...
function Js(i, t) {
  ...
  let r = t;
  return typeof s == "function" && (r = s(r)), j(r) || (r = typeof s == "string" ? e.parse(r, s) : e.parse(r)), r === null ? null : (n && (r = n === "week" && (Wt(o) || o === !0) ? e.startOf(r, "isoWeek", o) : e.startOf(r, n)), +r);
}
function Zs(i, t, e, s) {
  const n = J.length;
...
class en extends jt {
  ...
  _generate() {
    const t = this._adapter, e = this.min, s = this.max, n = this.options, o = n.time, r = o.unit || Zs(o.minUnit, e, s, this._getLabelCapacity(e)), a = P(n.ticks.stepSize, 1), l = r === "week" ? o.isoWeekday : !1, c = Wt(l) || l === !0, h = {};
    let d = e, f, u;
    ...
    for (f = d, u = 0; f < s; f = +t.add(f, a, r), u++)
      Qs(h, f, g);
    return (f === s || n.bounds === "ticks" || u === 1) && Qs(h, f, g), Object.keys(h).sort(Gs).map((p) => +p);
  }
  getLabelForValue(t) {
...
function rh(i) {
  ...
  Ri(() => {
    d.current && (a ? (u(), setTimeout(f)) : (Fi(d.current.data, r) || (d.current.data = r), n && !Fi(d.current.options, n) && (d.current.options = n), d.current.update(l)));
  }, [a, l, r, n]), Ri(() => (f(), () => u()), []);
  const f = () => {
    h.current && (d.current = new Ne(h.current, {
      type: s,
      data: r,
      options: n,
      plugins: o
...
function $t(i, t) {
  return Ne.register(t), sn((e) => /* @__PURE__ */ gt(rh, { ...e, type: i }));
}
const ah = $t("line", ma), lh = $t("bar", ua), ch = $t("pie", xa), hh = $t("scatter", ya), dh = $t("radar", _a), fh = $t("polarArea", ba), uh = {
  elements: {
    line: {
      borderWidth: 3
    }
...
function Qt(i) {
  const t = Math.floor(i) % Ii.length;
  return Ii[t];
}
const ph = sn((i) => {
  ...
  let h;
  if (t === "line")
    h = /* @__PURE__ */ gt(ah, { ...c, data: l });
  else if (t === "bar")
    h = /* @__PURE__ */ gt(lh, { ...c, data: l });
  else if (t === "pie")
    h = /* @__PURE__ */ gt(ch, { ...c, data: l });
  else if (t === "radar") {
    const d = {
      labels: n,
      datasets: o.map((f, u) => {
    ...
    const d = {
      datasets: o.map((f, u) => ({
        label: f.label,
        data: f.data.map((g, p) => ({ y: g, x: Zn(n[p])[1] })),
        backgroundColor: Qt(u * Zt)
      }))
    };
    h = /* @__PURE__ */ gt(hh, { ...c, data: d });
  } else if (t === "polarArea") {
    const d = {
      labels: n,
      datasets: o.map((f) => {
        const u = Array.from({ length: f.data.length }).fill("").map((g, p) => Qt(p * Zt));
        return {
          ...f,
          backgroundColor: u
        };
...
//# sourceMappingURL=Chart-BIXpBUW5.mjs.map
