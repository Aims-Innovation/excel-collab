...
const defaultLanguageTranslation = {
  ...
  'toolbar-align-middle': 'Align middle',
...
const locales: Record<LanguageType, Partial<Record<TranslationKeys, string>>> = {
  ...
  'ar-SA': {
    ...
    'format-as-currency': 'تنسيق كعملة',
    'format-as-percent': 'تنسيق كنسبة مئوية',
    'decrease-decimal': 'تقليل المنازل العشرية',
    'increase-decimal': 'زيادة المنازل العشرية',
    'increase-font-size': 'تكبير حجم الخط',
    'decrease-font-size': 'تصغير حجم الخط',
    'insert-function': 'إدراج دالة',
    autosum: 'الجمع التلقائي (العمود أعلاه)',
    'toolbar-undo': 'تراجع (Ctrl+Z)',
    'toolbar-redo': 'إعادة (Ctrl+Y)',
    'toolbar-bold': 'غامق (Ctrl+B)',
    'toolbar-italic': 'مائل (Ctrl+I)',
    'toolbar-strike': 'يتوسطه خط (Ctrl+5)',
    'toolbar-underline': 'تسطير (Ctrl+U)',
    'toolbar-text-color': 'لون النص',
    'toolbar-fill-color': 'لون التعبئة',
    'toolbar-align-left': 'محاذاة لليسار',
    'toolbar-align-center': 'توسيط أفقي',
    'toolbar-align-right': 'محاذاة لليمين',
    'toolbar-align-top': 'محاذاة للأعلى',
    'toolbar-align-middle': 'توسيط رأسي',
    'toolbar-align-bottom': 'محاذاة للأسفل',
    'section-history': 'السجل',
    'section-clipboard': 'الحافظة',
    'section-number': 'الأرقام',
    'section-font': 'الخط',
    'section-style': 'النمط',
    'section-format': 'التنسيق',
    'section-align': 'المحاذاة',
    'section-cells': 'الخلايا',
    'section-insert': 'إدراج',
    format: 'تنسيق',
    'insert-sheet': 'إدراج ورقة',
    'delete-sheet': 'حذف الورقة',
    'delete-cells': 'حذف الخلايا',
    'hide-sheet': 'إخفاء الورقة',
    'rename-sheet': 'إعادة تسمية الورقة',
    'line-chart': 'مخطط خطي',
    'bar-chart': 'مخطط أعمدة',
    'pie-chart': 'مخطط دائري',
    'scatter-chart': 'مخطط مبعثر',
